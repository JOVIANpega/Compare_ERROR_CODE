# Error Code Comparer v1.6.0 (Build 1)
...
AI 推薦會在 Excel 檔案中新增四個欄位：

| 欄位 | 內容 | 說明 |
|------|------|------|
| **E** | `AI推薦 test ID 1` | 第一個推薦的 Test ID |
| **F** | `AI推薦 test ID 2` | 第二個推薦的 Test ID |
| **G** | `AI推薦 中文 1` | 第一個 Test ID 對應的中文描述 |
| **H** | `AI推薦 中文 2` | 第二個 Test ID 對應的中文描述 |
